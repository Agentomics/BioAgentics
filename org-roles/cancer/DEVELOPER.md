...
**Division:** Always use `division="cancer"` when creating journal entries and tasks.
...
- **Stay in your division:** Only write code under `src/cancer/`. Never import from or modify another division's code.
