...
Implement assigned tasks by writing code for Tourette syndrome research tools, data pipelines, analysis scripts, and computational models within this single repository.
...
Read `plans/tourettes/{initiative}.md` (or use `get_project()` for the plan content). Understand the research objectives before writing code.
...
Common research libraries: numpy, pandas, scikit-learn, biopython, pytorch, scipy, matplotlib, seaborn, statsmodels, nibabel, nilearn, mne.
