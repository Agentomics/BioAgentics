...
2. **Feature engineering**:
   ...
   - *Transcriptomic*: Fibrosis pathway scores (TGFβ, Wnt, collagen, MMP, EMT signatures from MSigDB). Top differentially expressed genes between progressors and non-progressors. **Priority candidate genes from IBD 2025 8-gene stricture panel** (doi:10.1093/ibd/izaf026): LY96, AKAP11, SRM, GREM1, EHD2, SERPINE1, HDAC1, FGF2. GREM1 (BMP antagonist, fibroblast-specific, AUC ≥0.75) and SERPINE1 (PAI-1, ECM remodeling) are highest priority for stability selection given cell-type specificity and biological plausibility. **TL1A pathway genes**: TNFSF15 (TL1A) and TNFRSF25 (DR3) expression as candidate features. TL1A signals through DR3 to drive both inflammation and fibrosis simultaneously — a dual mechanism distinct from other cytokine pathways. TNFSF15 has established GWAS associations with CD. Anti-TL1A antibodies (duvakitug Phase 2b: 48% endoscopic response vs 13% placebo; tulisokibart Phase 2a: significant endoscopic response) are advancing to Phase 3, making TL1A pathway activity a therapeutically actionable feature. Patients with active TL1A-driven fibrotic programs may be identifiable from transcriptomics and stratified for emerging anti-TL1A therapies. **Creeping fat fibroblast markers (CTHRC1/YAP-TAZ axis)**: CTHRC1, POSTN, CCN1 expression levels as individual features. YAP/TAZ mechanotransduction target gene set score (from MSigDB or custom from Cell 2025, doi:10.1016/j.cell.2025.09.018). CTHRC1+ fibroblasts are the primary pro-fibrotic population in CD strictures, originating from mesenteric adipose tissue and driving fibrosis via ECM deposition. SERPINE1 overlap with the 8-gene panel validates this pathway. Additional scRNA-seq reference data available (GSE275144). **CD38 fibrosis progression marker**: CD38 expression as a feature capturing the IgA plasma cell–inflammatory fibroblast interaction axis (J Crohn's Colitis 2025, doi:10.1093/ecco-jcc/jjaf130). PECAM1–CD38 signaling drives the inflammation-to-fibrosis transition specifically in CD (not UC). CD38 inhibition reduced fibrosis in mouse model — making CD38 expression a potentially druggable risk feature. **TNC and CPA3 — protein-level validated fibrosis markers**: Layer-resolved proteomics (JCI Insight 2026, PMID 41665933) confirmed CTHRC1/POSTN at protein level (cross-platform validation of scRNA-seq) and identified two new candidates: TNC (tenascin-C) enriched in stricture submucosa — serum-measurable ECM protein, potential non-invasive monitoring feature; CPA3 (carboxypeptidase A3, mast cell marker) enriched in muscularis propria — adds a distinct mast cell pathway alongside plasma cells (CD38) and mechanosensitive fibroblasts (YAP/TAZ). The same study confirmed progressive "field effect" fibrosis extending beyond visible stricture, independently validated by a multicenter study (n=268, J Gastroenterol 2026, PMID 41746330) showing histopathological fibrosis severity predicts postoperative clinical recurrence (HR 1.95 per SD increase) — confirms fibrosis as an independent outcome predictor and supports early subclinical detection.
